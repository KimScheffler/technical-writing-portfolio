# Glossary / Do-not-translate list – memoQ (EN)

> **Note:**  
> The following terms are **UI labels** and must be used exactly as shown  
> to match the memoQ user interface.
...
| Quick Add Term | Adds a term without opening the full dialog |
| Ribbon | Top menu area containing commands and tabs |
