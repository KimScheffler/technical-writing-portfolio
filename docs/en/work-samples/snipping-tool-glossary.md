# Glossary – Snipping Tool

> **Language note:**  
> - This documentation is written in **American English (AE)**.  
> - UI elements are reproduced exactly as they appear in the original user interface, including **British English (BE)** spellings where applicable (for example, *Colour picker*).
...
| Textextraktor | Text extractor | Feature for recognizing and copying text from images (OCR) |
| Zeilenumbrüche entfernen | Remove line breaks | Option in the Text Extractor to remove automatic line breaks |
