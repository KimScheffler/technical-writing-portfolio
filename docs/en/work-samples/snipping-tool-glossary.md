...
| Screenshot | Bildschirmfoto | Single-image capture of the screen |
| Snip | Ausschnitt | Central control for selecting photo and video capture modes |
| Snipping area | Ausschnittbereich | The actual area of the screen that is selected |
| Text extractor | Textextraktor | Feature for recognizing and copying text from images (OCR) |
