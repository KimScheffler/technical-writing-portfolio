...
This documentation describes core Snipping Tool features as available in **Windows 11** at the time of writing. Individual features or user interface elements may vary depending on the Windows version or application updates.
...
Controls from left to right in the toolbar:
...
- **Colour picker** – Captures a color value from the screen. This control is available only in capture mode.
