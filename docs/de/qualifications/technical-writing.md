...
Die im Kurs vermittelten Methoden und Workflows werden in den Dokumentationsbeispielen
dieses Portfolios (z. B. Snipping Tool, memoQ, Style Guide) konsequent angewendet.

![Zertifikat über den Abschluss des Online-Kurses „Technical Writing: How to Write Software Documentation“](../../assets/certificates/technical-writing.jpg)

---

## Kursinhalte und Schwerpunkte

Der Kurs vermittelt die Grundlagen der Software-Dokumentation mit starkem Fokus auf
praktische Anwendung. Zentrale Themen sind:
...
Das Training kombiniert Videolektionen, praktische Übungen und Aufgaben, um eine direkte
und nachhaltige Anwendung der Inhalte zu ermöglichen.
